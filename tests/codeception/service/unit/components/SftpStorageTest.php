...
use service\components\storages\SftpStorage;
...
class SftpStorageTest extends TestCase
{
    public function testStorage()
    {
        ...
        $storage->setHost(SFTP_STORAGE_HOST);
        $storage->setPort(SFTP_STORAGE_PORT);
        $storage->setUsername(SFTP_STORAGE_USERNAME);
        $storage->setPassword(SFTP_STORAGE_PASSWORD);
        $storage->setRoot(SFTP_STORAGE_ROOT);
        //Test storage info
        ...
        $this->assertInstanceOf('service\components\contents\SftpContent', $content);
        //Test write to file
