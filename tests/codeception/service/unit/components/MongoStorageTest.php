...
use service\components\storages\MongoStorage;
...
class MongoStorageTest extends TestCase
{
    public function testStorage()
    {
        ...
        $storage->setDsn(MONGO_STORAGE_DSN);
        $storage->setRoot(MONGO_STORAGE_ROOT);
        //Test storage info
        ...
        $this->assertInstanceOf('service\components\contents\MongoContent', $content);
        //Test write to file
