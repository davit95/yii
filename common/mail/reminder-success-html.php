										...
										<tr>
											<td valign="top">
												<div style="color:#737373;font-family:Arial;font-size:14px;line-height:150%;text-align:left">
													...
													<p>Your <b><font color="#0077cc">Order # <?= $content['order_key'] ?></font></b> is successfully completed.</p>

													<p>For your reference, your order details are shown below.<br></p>
													<hr><h3 style="color:#505050;display:block;font-family:Arial;font-size:26px;font-weight:bold;margin-top:10px;margin-right:0;margin-bottom:10px;margin-left:0;text-align:left;line-height:150%">Order details:</h3>
