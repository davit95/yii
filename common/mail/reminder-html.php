										...
										<tr>
											<td valign="top">
												<div style="color:#737373;font-family:Arial;font-size:14px;line-height:150%;text-align:left">
													...
													<p>
														Thank you for using premium plan.<br>
														<font style="color:#0077cc;font-weight:bold">Your plan days is over.</font>
														<b>To buy new premium plan again click this link</b><a href="dev.premiumlinkgenerator.com/price">Buy Again</a>
													</p>
													<hr>
													<b style="color:#505050;display:block;font-family:Arial;font-size:30px;font-weight:bold;margin-top:10px;margin-right:0;margin-bottom:10px;margin-left:0;text-align:left;line-height:150%">Your Plan details
													</b>
													<table style="width:100%;border:1px solid #eee" border="1" cellpadding="6" cellspacing="0">
														<thead>
															<tr>
																<th scope="col" style="text-align:left;border:1px solid #eee">Plan Name</th>
																<th scope="col" style="text-align:left;border:1px solid #eee">Plan days</th>
																<th scope="col" style="text-align:left;border:1px solid #eee">Plan Limit</th>
																<th scope="col" style="text-align:left;border:1px solid #eee">Plan Amount</th>
															</tr>
														</thead>
														<tbody>
														<tr>
