...
/**
 * junocloud.me content
 */
class JunoCloudMe extends HttpContent
{
    private $proxy;
    private $userAgent;
    private $authCookies;
    ...
    public function getDownloadLink($url)
    {
        ...
        //In case of Location header update URL
        $url = $req->getUrl();
        ...
        do {
            ...
            for ($i = 0; $i < $forms->length; $i++) {
                if ('F1' == $forms->item($i)->getAttribute('name')) {
                    $form = $forms->item($i);
                    break;
                }
            }
            ...
            if (!preg_match('/http:\/\/storage\.junocloud\.me(:\d+)?\/.+/', $link)) {
                if (!empty($link)) {
