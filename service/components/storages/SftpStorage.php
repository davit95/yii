...
use service\components\contents\SftpContent;

/**
 * Class implements content storage on server via sFTP
 */
class SftpStorage extends Storage
{
    ...
    {
        if (!in_array('ssh2.sftp', stream_get_wrappers())) {
            throw new Exception('No stream wrapper found. SSH2 extension is required to use sftp storage.');
        }
