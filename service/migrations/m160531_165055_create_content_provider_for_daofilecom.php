...
class m160531_165055_create_content_provider_for_daofilecom extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->insert('{{%content_providers}}', [
            'name' => 'daofile.com',
            'class' => 'service\\components\\DaoFileCom',
            'url_tpl' => 'https:\/\/daofile\.com\/.+',
            'auth_url' => 'https://daofile.com',
            'downloadable' => 1,
            'streamable' => 0,
            'status' => 'ACTIVE'
        ]);
        ...
        $this->insert('{{%credentials}}', [
            ...
            'pass' => utf8_encode(Yii::$app->security->encryptByKey('DtT8D6cr5X8lnH5', $key)),
            'status' => 'ACTIVE'
        ]);
