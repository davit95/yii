...
<section class="vouchers-content" style="display: block;">
    <div class="h4 thin"><?=Yii::t('reseller_profile', 'Pay vouchers') ?></div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="ta-center tx-blue sm-hide xs-hide">
                    <a href="<?= Url::to(['@reseller_pay_voucher', 'id' => $voucher->id]) ?>">Pay</a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php if (empty($vouchers)): ?>
            <tr>
                <td class="ta-center sm-hide xs-hide" colspan="7">No unpayed vouchers</td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
