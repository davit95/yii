    ...
    <body class="invoice-body">
                ...
                <tr>
                    ...
                    <td>
                        <div class="address cl-white">
                            <?= InvoiceHelper::getFormattedCustomerInfo($transaction); ?>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <main>
            ...
            <div class="block invoice-to">
                <ul class="list">
                    <li>Invoiced To</li>
                    <?= InvoiceHelper::getFormattedAddress(true); ?>
                </ul>
            </div>
            <div class="block invoice-details">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" class="text-align-left"><?= $transaction->getTransactionData('purpose', '-') ?></td>
