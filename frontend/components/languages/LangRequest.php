...
class LangRequest extends Request
{
    ...
    public function getLangUrl()
    {
        if ($this->_lang_url === null) {
            ...
            Languag::setCurrent($lang_url);

                if( $lang_url !== null && $lang_url === Languag::getCurrent()->url && 
                strpos($this->_lang_url, Languag::getCurrent()->url) === 1 )
                {
                    $this->_lang_url = substr($this->_lang_url, strlen(Languag::getCurrent()->url)+1);
                }
        }
